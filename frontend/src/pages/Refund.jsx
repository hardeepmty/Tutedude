        ...
        <div className="step-container">
          <div className="step">
            <div className="step-details">
              <h4>Step 1 : Enroll into your favorite course for only ₹1,499</h4>
              <p>Start Learning with Lifetime Course Access.</p>
            </div>
          </div>
          <div className="step">
            <div className="step-details">
              <h4>Step 2 : Complete Course & Assignments within 2 Years!</h4>
          ...
          <div className="step">
            <div className="step-details">
              <h4>Step 3 : Receive 100% Refund upon completion</h4>
              <div style={{display:"flex", gap:"10px", border:"2px solid #E5E5E8", borderRadius:"20px", padding:"10px"}}>
